  ...
  return (
    <StyledWhyChooseUs>
      ...
      <Stack>
        ...
        <Typography mt={2}>
          Gadget repair services involve the professional repair and mainten of
          electronic devices and gadgets, including but not limited to the
          smartphones, tablets, laptops, other consumer electronics.
        </Typography>
        <List>
