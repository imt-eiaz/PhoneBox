...
export const footer_links = [
  ...
  {
    title: "Quick Links",
    items: ["Home", "About", "Services", "Blogs"],
  },
];

export const footer_social = [
  {
    link: "tel:+447771835383",
    icon: PhoneIcon,
  },
  {
    link: "imatphonebox@gmail.com",
    icon: AlternateEmailIcon,
  },
  {
    link: "https://www.facebook.com/phonebox.cirencester",
    icon: FacebookIcon,
  },
  {
    link: "https://www.linkedin.com/in/dfsdfsi/",
    icon: LinkedInIcon,
  },
  {
    link: "https://github.com/dfsdsdf",
    icon: GitHubIcon,
  },
];
...
export const features = [
  {
    ...
    title: "NO FIX, NO FEE",
    secondary: "Repair on Demand",
  },
  {
    icon: CalendarMonthRoundedIcon,
    title: "30 DAYS WARRANTY",
    secondary: "Guaranteed Service",
  },
  {
